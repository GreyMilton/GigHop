    ...
    <ScrollView>
      <View style={formsStyles.addGigContainer}>
        <Form
          ...
          buttonText="Submit New Gig"
          buttonStyle={formsStyles.submitButton}
          buttonTextStyle={formsStyles.submitButtonText}
        >
          <View style={formsStyles.formItemContainer}>
            <FormItem
              isRequired
              label="Gig name"
              labelStyle={formsStyles.label}
              textInputStyle={formsStyles.input}
              value={eventName}
          ...
          <View style={formsStyles.timeAndDateInputContainer}>
            ...
            <View style={formsStyles.timeAndDateButtonContainer}>
              <Pressable
                style={formsStyles.datePickerButtonAndroid}
                onPress={showDatePickerStart}
              >
                <Text style={formsStyles.timeOrDatePickerButtonTextAndroid}>
                  {startTime.toDateString()}
                </Text>
              </Pressable>
              <Pressable
                style={formsStyles.timePickerButtonAndroid}
          ...
          <View style={formsStyles.entryFeeContainer}>
            ...
            <CurrencyInput
              style={formsStyles.entryFeeInput}
              prefix="£"
              separator="."
              label="Event price"
              value={price}
              onChangeValue={(price) => setPrice(price)}
            />
          </View>
          <View style={formsStyles.formItemContainer}>
            <FormItem
