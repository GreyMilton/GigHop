  ...
  return (
    <View style={mainScreenStyles.EventSummaryCalloutView} >
      <>
        ...
        <Text>{(event['entry_price']["$numberDecimal"] === 0 || event['entry_price']["$numberDecimal"] === undefined || event['entry_price']["$numberDecimal"] === "0") ? 'Free entry' : "£" + event['entry_price']["$numberDecimal"] }</Text>
      </>
    </View>
  );
}